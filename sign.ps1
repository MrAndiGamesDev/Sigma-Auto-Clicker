...
$Executable = "dist\Sigma Auto Clicker (v$Version)\Sigma Auto Clicker (v$Version).exe"
#endregion
...
SET "FILE_TO_SIGN=dist\Sigma Auto Clicker (v%VERSION%)\Sigma Auto Clicker (v%VERSION%).exe"
SET "ENV_FILE=.env"
